  ...
  const caseStudies: CaseStudy[] = [
    {
      ...
      challengesAndSolutions: "Encountered scalability issues which were resolved by refactoring key components.",
      resultsAndImpact: "Results: [Details to be added]",
      keyTakeawaysAndFutureImprovements: "Key learnings include improved performance and future improvements will focus on enhanced user experience.",
    ...
    },
    {
      ...
      challengesAndSolutions: "Faced integration challenges which were overcome by implementing modular design principles.",
      resultsAndImpact: "Results: [Details to be added]",
      keyTakeawaysAndFutureImprovements: "Key takeaways involve the importance of modularity, with plans to further optimize system performance.",
    ...
    },
    {
      ...
      challengesAndSolutions: "Encountered real-time data synchronization issues which were resolved with Firebase’s advanced features.",
      resultsAndImpact: "Results: [Details to be added]",
      keyTakeawaysAndFutureImprovements: "Key takeaways include the necessity of thorough testing; future improvements will target increased stability and scalability.",
      conclusion: "Project Gamma proved to be a valuable learning experience and a testament to our ability to innovate under pressure."
    }
  ];
